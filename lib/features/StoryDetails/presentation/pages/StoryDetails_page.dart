...
//           },
//         ),
//         floatingActionButton: _buildFloatingActionButtons(widget.childId),
...
//   }
//
//   Widget? _buildFloatingActionButtons(int childId) {
...
//             BlocProvider(
//               create: (context) => getIt.get<KidsFavoriteImageCubit>(),
...
//   }
//
//   void _confirmDeleteExistingImage(StoryDetails story, int childId) async {
//     setState(() {
//       _isSaving = true;
//     });
//
...
//     // مثال:
//     final kidsFavoriteImageCubit = context.read<KidsFavoriteImageCubit>();
//     await kidsFavoriteImageCubit.deleteKidsFavoriteImage(
//       storyId: story.favoriteImage!.idFavoriteImage!,
//       idChildren: childId,
//     );
//
//     // محاكاة عملية الحذف
...
class _StoryDetailsPageState extends State<StoryDetailsPage> {
  ...
  void initState() {
    super.initState();
    viewModel = getIt.get<StoryDetailsCubit>();
    imageManager = StoryImageManager(context);
    viewModel.getStoryDetails(widget.storyId, widget.childId);
  }
