...
class MaintenancePage extends StatefulWidget {
  ...
  const MaintenancePage({super.key, required this.appStatus});
...
class _MaintenancePageState extends State<MaintenancePage>
      ...
      child: Column(
        children: [
          Text(
            ...
            style: getBoldStyle(color: Colors.white, fontSize: 25).copyWith(
              shadows: [
                Shadow(
  ...
  void _refreshAppStatus() {
    Future.delayed(Duration(seconds: 2), () {
      if(!mounted)return;
      WelcomeCubit.get(context).getAppStatus();
    });
