...
class _ApiService implements ApiService {
  ...
  @override
  Future<CheckCodeDto?> checkCode(CheckCodeRequest? checkCodeRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(checkCodeRequest?.toJson() ?? <String, dynamic>{});
    final _options = _setStreamType<CheckCodeDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'user_codes/check_code',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late CheckCodeDto? _value;
    try {
      _value = _result.data == null
          ? null
          : CheckCodeDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<UseCodeDto?> useCode(UseCodeRequest? useCodeRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(useCodeRequest?.toJson() ?? <String, dynamic>{});
    final _options = _setStreamType<UseCodeDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'user_codes/use_code',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late UseCodeDto? _value;
    try {
      _value = _result.data == null ? null : UseCodeDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
